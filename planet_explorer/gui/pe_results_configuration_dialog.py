...
class ResultsConfigurationDialog(BASE, WIDGET):
    def __init__(self, selection, parent=None):
        ...
        self.buttonBox.button(QDialogButtonBox.StandardButton.Ok).clicked.connect(self.accepted)
        self.buttonBox.button(QDialogButtonBox.StandardButton.Cancel).clicked.connect(self.rejected)
